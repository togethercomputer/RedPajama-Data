...
pca = load_pca('/home/karan/data/pyjama/features/sentence-transformers/all-MiniLM-L6-v2/pca32.faiss')

model_name = "sentence-transformers/all-MiniLM-L6-v2"
model, tokenizer = create_model_and_tokenizer(model_name)

# df = mk.DataFrame.from_feather(os.path.expanduser("~/data/pyjama/processed/consolidated.feather"))
df = mk.DataFrame.read('/home/karan/data/pyjama/huggingface/github.mk')
